...
const MASTER_PROMPTS = [
    // MARKETING & COPYWRITING (9 Prompts)
    ...
    { category: 'Marketing', title: "Sequência de Onboarding", icon: "👋", desc: "Guie novos usuários para o 'Aha! Moment'.", content: "Crie uma sequência de 3 e-mails de onboarding para novos usuários do [SOFTWARE/APP]. E-mail 1: Boas-vindas + Configuração rápida. E-mail 2: Dica de valor rápido (Quick Win). E-mail 3: Estudo de caso inspirador." },
    { category: 'Marketing', title: "Landing Page de Alta Conversão", icon: "📄", desc: "Estrutura completa de seções persuasivas.", content: "Desenvolva a estrutura de texto (Wireframe de Copy) para uma Landing Page de [PRODUTO]. Inclua: Headline, Subheadline, Benefícios Chave, Prova Social, Oferta Irresistível, Garantia e FAQ." },

    // DESIGN & IMAGEM (9 Prompts)
    ...
    { category: 'Design', title: "Logotipo Vetorial (Flat)", icon: "✏️", desc: "Design limpo e escalável para marcas tech.", content: "Crie um prompt para um logotipo vetorial estilo Flat Design para uma empresa de [SETOR]. O ícone deve ser [ELEMENTO: ex: uma raposa], simples, cores sólidas, sem sombras ou degradês, fundo branco." },
    { category: 'Design', title: "Mockup de Embalagem", icon: "📦", desc: "Visualização premium de produtos físicos.", content: "Gere uma imagem de mockup de embalagem (packaging) para [PRODUTO]. Estilo minimalista e premium. Iluminação suave de estúdio, texturas foscas, e detalhes em foil dourado/prata." },
    { category: 'Design', title: "Poster Cinematic", icon: "🎬", desc: "Composição dramática e tipografia integrada.", content: "Crie um poster de filme cinematográfico sobre [TEMA]. Estilo visual inspirado em [DIRETOR/FILME]. Contraste alto, tipografia integrada à imagem, paleta de cores [CORES]." },
    { category: 'Design', title: "Ícones de App (iOS)", icon: "📲", desc: "Conjunto coeso de ícones para interfaces.", content: "Gere um set de 4 ícones de aplicativo estilo iOS 17 para um app de [TEMA]. Fundo com gradiente sutil, glifo central branco simplificado, bordas arredondadas (squircle)." },

    // VÍDEO & ROTEIRO (9 Prompts)
    ...
    { category: 'Vídeo', title: "Roteiro de VSL (Vendas)", icon: "💸", desc: "Persuasão para vender produtos high-ticket.", content: "Escreva o roteiro de uma VSL (Video Sales Letter) para vender [PRODUTO]. Siga a estrutura: Promessa Ousada -> História de Luta -> A Descoberta do Método -> Prova Social -> Oferta -> Garantia." },
    { category: 'Vídeo', title: "Podcast Intro & Outro", icon: "🎙️", desc: "Abertura e fechamento profissional.", content: "Crie o script de introdução e encerramento para um podcast sobre [TEMA]. Intro: Música (descrição), Boas-vindas energética, Gancho do episódio. Outro: Recapitulação rápida, CTA para compartilhar e avaliar." },
    { category: 'Vídeo', title: "Tutorial Passo a Passo", icon: "🛠️", desc: "Explicação clara para produtos digitais.", content: "Crie um roteiro de tutorial screencast ensinando a fazer [TAREFA] no software [NOME DO SOFTWARE]. Divida em passos claros e numerados, indicando onde dar zoom na edição." },
    { category: 'Vídeo', title: "Depoimento Guiado", icon: "⭐", desc: "Perguntas para extrair os melhores depoimentos.", content: "Liste 5 perguntas estratégicas para entrevistar um cliente satisfeito e obter um depoimento perfeito. O objetivo é que ele fale sobre: A dúvida inicial, O resultado obtido e Por que recomendaria." },
    { category: 'Vídeo', title: "Live de Lançamento", icon: "🔴", desc: "Estrutura de retenção para transmissões ao vivo.", content: "Estruture o roteiro de uma Live de Lançamento de 1 hora. Blocos: 0-10min (Aquecimento e História), 10-40min (Conteúdo Épico + Quebra de Objeções), 40-50min (Revelação da Oferta), 50-60min (QA e Fechamento)." },

    // NEGÓCIOS & ESTRATÉGIA (9 Prompts)
    ...
    { category: 'Negócios', title: "OKRs Trimestrais", icon: "🎯", desc: "Defina objetivos e resultados chave ambiciosos.", content: "Ajude-me a definir 3 OKRs (Objetivos e Resultados-Chave) para o time de [ÁREA] para o próximo trimestre. Foco estratégico: [FOCO: ex: Crescimento Agressivo]." },
    { category: 'Negócios', title: "Análise de Concorrência", icon: "🕵️", desc: "Mapeamento de pontos fortes e fracos.", content: "Crie uma tabela comparativa analisando os competidores [CONCORRENTE A] e [CONCORRENTE B] em relação à minha empresa [MINHA EMPRESA]. Critérios: Preço, Diferencial, Marketing e Experiência do Usuário." },
    { category: 'Negócios', title: "Job Description (Vaga)", icon: "💼", desc: "Atraia talentos top 1% do mercado.", content: "Escreva uma descrição de vaga (Job Description) para a posição de [CARGO]. Use tom de voz [TOM: ex: Desafiador e Inspirador]. Liste responsabilidades, requisitos e, principalmente, 'Por que trabalhar aqui?'." },
    { category: 'Negócios', title: "Feedback Construtivo", icon: "🥪", desc: "Técnica sanduíche para conversas difíceis.", content: "Preciso dar um feedback construtivo para um colaborador que [SITUAÇÃO: ex: entrega atrasado mas com qualidade]. Escreva o roteiro da conversa usando a técnica Sanduíche (Elogio Sincero > Ponto de Melhoria > Encorajamento)." },
    { category: 'Negócios', title: "Nomes Criativos (Naming)", icon: "💡", desc: "Gere nomes disponíveis e memoráveis.", content: "Gere 20 ideias de nomes criativos para [PROJETO/EMPRESA/PRODUTO]. Vibe desejada: [VIBE: ex: Moderna, Tecnológica, Minimalista]. Verifique se os nomes são curtos e fáceis de soletrar." },

    // TECNOLOGIA & DEV (9 Prompts)
    ...
    { category: 'Tech', title: "Gerador de Testes (Jest)", icon: "✅", desc: "Crie testes unitários robustos automaticamente.", content: "Escreva casos de teste unitário usando [FRAMEWORK: ex: Jest/Vitest] para a seguinte função: [CÓDIGO DA FUNÇÃO]. Cubra casos de sucesso e principais edge cases (erros)." },
    { category: 'Tech', title: "Docs de API (Swagger)", icon: "📜", desc: "Documentação padrão OpenAPI.", content: "Gere a especificação OpenAPI (Swagger) em YAML para o seguinte endpoint da API: [DESCRIÇÃO DO ENDPOINT E PARÂMETROS]. Inclua exemplos de Request e Response." },
    { category: 'Tech', title: "Otimização SQL", icon: "⚡", desc: "Melhore a performance de consultas lentas.", content: "A seguinte query SQL está lenta: [QUERY]. Analise e sugira otimizações, como criação de índices ou reescrita da consulta. Banco de dados: [TIPO: ex: PostgreSQL]." },
    { category: 'Tech', title: "Commit Semântico", icon: "git", desc: "Padronize seu histórico (Conventional Commits).", content: "Escreva uma mensagem de commit seguindo o padrão Conventional Commits para as seguintes alterações: [DESCREVA O QUE MUDOU]. Use tipos como feat, fix, chore, refactor, etc." },
    { category: 'Tech', title: "Dockerfile Otimizado", icon: "🐳", desc: "Containers leves e seguros.", content: "Escreva um Dockerfile otimizado (Multi-stage build) para uma aplicação [TECNOLOGIA: ex: Node.js/Python]. Foque em reduzir o tamanho final da imagem e segurança (não rodar como root)." },

    // EDUCAÇÃO & MENTORIA (9 Prompts)
    ...
    { category: 'Educação', title: "Quiz de Fixação", icon: "❓", desc: "Teste seu conhecimento com perguntas dinâmicas.", content: "Crie um quiz de múltipla escolha com 5 perguntas sobre [TEMA]. Ao final, mostre o gabarito e uma breve explicação para cada resposta correta." },
    { category: 'Educação', title: "Analogias Criativas", icon: "💡", desc: "Explique o inexplicável com comparações simples.", content: "Crie 3 analogias criativas para explicar [CONCEITO DIFÍCIL] para [PÚBLICO-ALVO]. As analogias devem usar elementos do universo desse público para facilitar o entendimento." },
    { category: 'Educação', title: "Debate Socrático", icon: "🏛️", desc: "Aprofunde seu conhecimento questionando premissas.", content: "Quero debater sobre [TEMA]. Atue como Sócrates. Não me dê respostas, apenas faça perguntas que desafiem minhas premissas e me façam refletir mais profundamente sobre o assunto." },
    { category: 'Educação', title: "Flashcards (Anki)", icon: "🎴", desc: "Memorização espaçada de conceitos chave.", content: "Crie uma lista de 10 flashcards (Frente: Pergunta/Conceito, Verso: Resposta/Definição) sobre [TEMA] para eu usar no Anki. Foque nos conceitos mais importantes e difíceis de memorizar." },
    { category: 'Educação', title: "Mentoria de Carreira", icon: "🚀", desc: "Aconselhamento personalizado para seu próximo passo.", content: "Atue como um Mentor de Carreira Sênior. Estou no momento [DESCREVA SEU MOMENTO ATUAL] e quero chegar em [OBJETIVO]. Analise meu perfil e sugira 3 passos concretos para eu avançar na minha carreira." },
];
